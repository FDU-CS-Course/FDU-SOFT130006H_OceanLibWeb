...
<template>
  <div class="page">
    <van-nav-bar id="toolbar" title="帮帮求助" left-text="返回" left-arrow @click-left="back" fixed placeholder></van-nav-bar>
...
export default {
  ...
  mounted() {
    userNotifyStore.pullUserNotifyList(this, () => {
      this.invitationList = userNotifyStore.getUserNotifyList().invitationList;
    });
  },
  data() {
    return {
